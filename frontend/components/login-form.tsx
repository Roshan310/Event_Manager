      ...
      <div className="grid gap-6">
        ...
        <div className="grid gap-2">
          <div className="flex items-center">
            ...
            <a
              href="#"
              className="ml-auto text-sm underline-offset-4 hover:underline transition-colors duration-200 hover:text-rose-600 dark:hover:text-rose-400"
            >
        ...
        <Button
          variant="outline"
          className="w-full transition-all duration-300 hover:scale-[1.02] hover:shadow-md hover:border-rose-300 hover:bg-rose-50 dark:hover:bg-rose-950/20 dark:hover:border-rose-600 active:scale-[0.98] transform-gpu"
        >
